                ...
                >
                    ...
                    <div className='fixed inset-0 overflow-y-auto'>
                        <div className='flex min-h-full items-center justify-center p-4 text-center'>
                            ...
                            >
                                <Dialog.Panel className={`relative max-w-lg w-full max-h-[90vh] overflow-y-auto rounded-2xl bg-white text-left shadow-xl transition-all flex flex-col gap-5 p-6`}>
                                    <button
                                        type='button'
                                        onClick={closeModal}
                                    ...
                                    <div className='flex-1 flex flex-col gap-2'>
                                        ...
                                        <h2 className='font-semibold textxl capitalize'>{car.make} {car.model}</h2>
